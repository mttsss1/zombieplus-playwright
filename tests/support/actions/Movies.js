...
export class Movies {
    ...
    async createMovie(movie) {
        ...
        await this.page.locator('.react-select__menu-list .react-select__option').filter({ hasText: movie.company }).click()

        await this.page.locator('#select_year .react-select__value-container').click()
        await this.page.locator('.react-select__menu-list .react-select__option').filter({ hasText: movie.release_year }).click()
